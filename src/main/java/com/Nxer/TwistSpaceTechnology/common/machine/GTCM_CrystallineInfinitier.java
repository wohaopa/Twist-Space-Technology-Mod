...
G -> ofFrame;
    ...
    protected GT_Multiblock_Tooltip_Builder createTooltip() {
        ...
        tt.addMachineType(TextLocalization.Tooltip_CrystallineInfinitier_MachineType.toString())
            .addInfo(TextLocalization.Tooltip_CrystallineInfinitier_00.toString())
            .addInfo(TextLocalization.Tooltip_CrystallineInfinitier_01.toString())
            .addInfo(TextLocalization.Tooltip_CrystallineInfinitier_02.toString())
            .addInfo(TextLocalization.Tooltip_CrystallineInfinitier_03.toString())
            .addInfo(TextLocalization.Tooltip_CrystallineInfinitier_04.toString())
            .addInfo(TextLocalization.Tooltip_CrystallineInfinitier_05.toString())
            .addInfo(TextLocalization.Tooltip_CrystallineInfinitier_06.toString())
