...
public class GT_TileEntity_PreciseHighEnergyPhotonicQuantumMaster
    ...
    protected GT_Multiblock_Tooltip_Builder createTooltip() {
        ...
        tt.addMachineType(TextLocalization.Tooltip_PhC_MachineType.toString())
            .addInfo(TextLocalization.Tooltip_PhC_00.toString())
            .addInfo(TextLocalization.Tooltip_PhC_01.toString())
            .addInfo(TextLocalization.Tooltip_PhC_02.toString())
            .addInfo(TextLocalization.Tooltip_PhC_03.toString())
            .addInfo(TextLocalization.Tooltip_PhC_04.toString())
            .addInfo(TextLocalization.Tooltip_PhC_05.toString())
            .addInfo(TextLocalization.Tooltip_PhC_06.toString())
            .addInfo(TextLocalization.Tooltip_PhC_07.toString())
            .addInfo(TextLocalization.Tooltip_PhC_08.toString())
            .addInfo(TextLocalization.Tooltip_PhC_09.toString())
            ...
            .addCasingInfoRange(TextLocalization.textCasingAdvIrPlated.toString(), 296, 347, false)
            .addCasingInfoRange(TextLocalization.textCasingTT_0.toString(), 0, 78, false)
            .addCasingInfoRange(TextLocalization.textUpgradeCasingAndLocation.toString(), 0, 25, false)
            .addInputHatch(TextLocalization.textCenterOfLRSides.toString(), 2)
            .addOutputHatch(TextLocalization.textCenterOfLRSides.toString(), 2)
            .addInputBus(TextLocalization.textCenterOfLRSides.toString(), 2)
            .addOutputBus(TextLocalization.textCenterOfLRSides.toString(), 2)
            .addMaintenanceHatch(TextLocalization.textAroundController.toString(), 1)
            .addEnergyHatch(TextLocalization.textHighPowerCasingUDSides.toString(), 3)
