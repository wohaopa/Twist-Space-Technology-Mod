...
public class GT_TileEntity_MagneticDrivePressureFormer
    ...
    protected GT_Multiblock_Tooltip_Builder createTooltip() {
        ...
        tt.addMachineType(TextLocalization.Tooltip_MagneticDrivePressureFormer_MachineType.toString())
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_00.toString())
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_01.toString())
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_02.toString())
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_03.toString())
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_04.toString())
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_05.toString())
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_06.toString())
            .addSeparator()
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_09.toString())
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_07.toString())
            .addInfo(TextLocalization.Tooltip_MagneticDrivePressureFormer_08.toString())
            .addSeparator()
            ...
            .addController(TextLocalization.textTopCenter.toString())
            .addInputHatch(TextLocalization.Tooltip_MagneticDrivePressureFormer_Hatches.toString(), 1)
            .addOutputHatch(TextLocalization.Tooltip_MagneticDrivePressureFormer_Hatches.toString(), 1)
            .addInputBus(TextLocalization.Tooltip_MagneticDrivePressureFormer_Hatches.toString(), 1)
            .addOutputBus(TextLocalization.Tooltip_MagneticDrivePressureFormer_Hatches.toString(), 1)
            .addMaintenanceHatch(TextLocalization.Tooltip_MagneticDrivePressureFormer_Hatches.toString(), 1)
            .addEnergyHatch(TextLocalization.Tooltip_MagneticDrivePressureFormer_EnergyHatch.toString(), 2)
